...
public final class Util {
	...
	public static void waitAndExit(int wait) {
		try {
			Thread.sleep(wait);
	...
	public static int convertRamArgToMB(String arg) {
		final String unit = arg.substring(arg.length() - 1, arg.length());
		System.out.println("unit=" + unit);
		final int value = Integer.valueOf(arg.substring(0, arg.length() - 1));
		System.out.println("value=" + value);
		int r = unit.equals("G") ? value * 1024 : value;
